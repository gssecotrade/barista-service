...
export const coffees: CoffeeProfile[] = [
  {
    handle: "geisha",
    name: "Geisha",
    category: "single_origin",
    ...
    whyChooseIt:
      "Ideal para quien busca una experiencia refinada, muy aromática y con personalidad delicada.",
  ...
  },
  {
    ...
    whyChooseIt:
      "Es la opción más versátil para quien quiere empezar a disfrutar el café con una taza amable y equilibrada.",
  ...
  },
  {
    ...
    whyChooseIt:
      "Perfecto para quien busca una taza con más presencia, cuerpo y persistencia.",
